...
class SGLANetwork(nn.Module):
    def __init__(self):
        super(SGLANetwork, self).__init__()
        ...
        self.cnn2 = nn.Sequential(nn.Conv2d(20, 25, kernel_size=10,stride=2,padding=1), nn.ReLU(inplace=True), nn.BatchNorm2D(25))
        self.se2 = SE_Block(25,16)
"""
