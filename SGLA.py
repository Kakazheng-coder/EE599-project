...
class SGLANetwork(nn.Module):
    ...
    '''
    def __init__(self, num_classes = 251, nchannels=[256,512,1024,2048], multi_scale = True ,learn_region=True, use_gpu=True):
        ...
        # construct SEnet154 
        senet154_ = senet154(num_classes=251, pretrained=None)
